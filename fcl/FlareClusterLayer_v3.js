    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            */
            ...
            var defaultTextSymbol = new TextSymbol()
                           ...
                           .setFont(new Font("10pt").setWeight(Font.WEIGHT_BOLD).setFamily("Arial"))
        ...
        _activateCluster: function (graphic) {
            ...
            for (i = 0, len = flareCount; i < len; i++) {
                ...
                sym = new PictureMarkerSymbol({"url": "fcl/images/" + attributes.iconURL, "width": 15, "height": 15, "type":"esriPMS"});
        ...
        _createTooltip: function (shape) {
            ...
            for (var i = 0, len = lines.length; i < len; i++) {
                var textShape = tooltipGroup.createText({ x: xPos, y: yPos + (i * 10), text: lines[i], align: 'middle' })
                    .setFill("#000")
                    .setFont({ size: 10, family: this.textSymbol.font.family, weight: this.textSymbol.font.weight });
